                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <div class="box-body">
                                    ...
                                    <div class="form-radio form-radio-inline">
                                         <label for="title" class="control-label"><span style="color:red">*</span>Gender</label><br>
                                        <!--<div style="padding-left:6px;font-size: 1rem" class="form-radio-legend control-label "><span style="color:red" class="control-label">*</span> Gender</div>-->
                                        <label class="form-radio-label">
                                            <input name=gender class="form-radio-field" type="radio"    {{$user_info->gender=='Male'?'checked':''}}  value="Male" />
                                            <i class="form-radio-button"></i>
                                            <span>Male</span>
                                        </label>
                                        <label class="form-radio-label">
                                            <input name=gender class="form-radio-field" type="radio" {{$user_info->gender=='Female'?'checked':''}}  value="Female" />
                                            <i class="form-radio-button"></i>
                                            <span>Female</span>
                                        </label>
                                    </div>
                                     ...
                                     <div class="col-md-12">
                                    <div class="form-radio form-radio-inline">
                                        <!--<div style="padding-left:6px;font-size: 1rem" class="form-radio-legend"><span style="color:red">*</span> </div>-->
                                        <label for="title" class="control-label"><span style="color:red">*</span> Marital Status </label><br>
                                        <label class="form-radio-label">
                                            <input name=marital_status class="form-radio-field" type="radio" value="Married" />
                                            <i class="form-radio-button"></i>
                                            <span>Married</span>
                                        </label>
                                        <label class="form-radio-label">
                                            <input name=marital_status class="form-radio-field" type="radio"  value="Unmarried" />
                                            <i class="form-radio-button"></i>
                                            <span>Unmarried</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                          <label for="title" class="control-label"><span style="color:red">*</span> NID/Birth/Passport/Driving </label>
                                            <div>
                                              <input type="text" class="form-control" id="email" name="nid" placeholder="NID/Passport/Birth Cirtificate/Driving license">
                                            </div>
                                        </div>
                                      </div>
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          <label for="title" class="control-label"><span style="color:red">*</span> Email </label>
                                            <div>
                                       ...
                                       <div class="col-md-12">
                                        <div class="form-group">
                                             <div class="form-group">
                                                <label for="title" class="col-8 control-label "><span style="color:red">*</span> Division</label>
                                      ...
                                      {{-- <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="title" class="control-label labelclass"><span style="color:red">*</span> Password </label>
                                          <div>
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <!--<input type="text" class="form-control" id="l_degree" name="l_degree" placeholder="Enter  Last Degree" required>-->
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="title" class="control-label"><span style="color:red">*</span> Score of Last Degree </label>
                                                <div>
