...
@section('frntcontent')
    ...
    <section class="page-banner-area"
             style="background: url({{'/'.$data['servicehead']->image}}); background-repeat: no-repeat; background-position: center; background-size: cover; background-attachment: fixed;">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                ...
                <div class="col-sm-12 all-s-details">
                    ...
                    <form action="{{url('/cvformstore')}}" method="post" id="cvcreateform"
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class=" step">
                                <a class="nav-link " id="pills-information-tab" data-toggle="pill"
                                   href="#pills-information" role="tab" aria-controls="pills-info" aria-selected="true"><i
                                        class="fas fa-user"></i> Personal Information</a>
                            </li>
                            <li class=" step">
                                <a class="nav-link" id="pills-education-tab" data-toggle="pill" href="#pills-education"
                                   role="tab" aria-controls="pills-education" aria-selected="false"><i
                                        class="fas fa-book-open"></i> Educational Qualification</a>
                            </li>
                            <li class=" step">
                                <a class="nav-link" id="pills-experience-tab" data-toggle="pill"
                                   href="#pills-experience" role="tab" aria-controls="pills-experience"
                                   aria-selected="false"><i class="far fa-file-alt"></i> Experience</a>
                            </li>
                            <li class=" step">
                                <a class="nav-link" id="pills-skills-tab" data-toggle="pill" href="#pills-skills"
                                   role="tab" aria-controls="pills-skills" aria-selected="false"><i
                                        class="fas fa-archive"></i> Skills</a>
                            </li>
                            <li class=" step">
                                <a class="nav-link" id="pills-reference-tab" data-toggle="pill" href="#pills-reference"
                                   role="tab" aria-controls="pills-reference" aria-selected="false"><i
                                        class="far fa-share-square"></i> Reference</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" style="max-width: 100%">
                                                <input type="date" oninput="this.className = ''" style="width: 100%;"
                                                       class="form-control" id="birthdate" name="birthdate"
                                                       value="{{old('birthdate')}}" placeholder="Enter Your Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label for="haddress" class="col-4 control-label labelclass"><span
                                                    style="color:red">*</span> Home Address</label>
                                            <div class="col-10" style="max-width: 100%">
                                                <input type="text" oninput="this.className = ''" style="width: 100%;"
                                                       class="form-control" id="haddress" name="haddress"
                                                       value="{{old('haddress')}}" placeholder="Enter  Address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="paddress" class="col-6 control-label labelclass"><span
                                                    style="color:red">*</span> Permanent Address</label>
                                            <div class="col-10" style="max-width: 100%">
                                                <input type="text" oninput="this.className = ''" style="width: 100%;"
                                                       class="form-control" id="paddress" name="paddress"
                                                       value="{{old('paddress')}}" placeholder="Enter  Address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="title" class="col-4 control-label labelclass"><span
                                                    style="color:red">*</span> Phone No</label>
                                            <div class="col-10" style="max-width: 100%">
                                                <input type="text" oninput="this.className = ''" style="width: 100%;"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-10" style="max-width: 100%">
                                                <input type="email" oninput="this.className = ''" style="width: 100%;"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="title" class="col-8 control-label labelclass"><span
                                                    style="color:red">*</span> Password(At least 8 characters) </label>
                                            <div class="col-10" style="max-width: 100%">
                                                <input type="password" oninput="this.className = ''"
                                                       style="width: 100%;" class="form-control" id="matchpassword"
                                    ...
                                    <div class="col-6">
                                        <div class="form-radio form-radio-inline">
                                            <div style="padding-left:6px;font-size: 1rem" class="form-radio-legend ">
                                                <span style="color:red">*</span> Gender
                                            </div>

                                            &nbsp;&nbsp;&nbsp; <input type="radio" oninput="this.className = ''"
                                                                      name="gender" class="form-radio-field"
                                                                      type="radio" checked required value="Male"/>
                                            <span>Male</span>
                                            &nbsp;&nbsp;&nbsp; <input type="radio" oninput="this.className = ''"
                                                                      name="gender" class="form-radio-field"
                                                                      type="radio" required value="Female"/>
                                            <span>Female</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="title" class="col-8 control-label labelclass"><span
                                                    style="color:red">*</span> Division</label>
                                            <div class="col-10" style="max-width: 100%">
                                    ...
                                    <div class="col-6">
                                        <div class="form-radio form-radio-inline">
                                            ...
                                            &nbsp;&nbsp;&nbsp; <input name="marital_status"
                                                                      ...
                                                                      class="form-radio-field" type="radio" required
                                                                      value="Married"/>
                                            <span>Married</span>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="title" class="col-8 control-label labelclass"><span
                                                    style="color:red">*</span> NID/Birth/Passport/Driving </label>
                                            <div class="col-10" style="max-width: 100%">
                                                <input type="text" class="form-control" style="width: 100%;"
                                                       oninput="this.className = ''" id="matchpassword" name="nid"
                                                       value="{{old('nid')}}"
                                                       placeholder="NID/Passport/Birth Cirtificate/Driving license">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <textarea name="objective" class="form-control" rows="4"
                                                      placeholder="Write Objective....">{{old('objective')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin:2px;">
                                ...
                                <div class="row" style="margin:2px;">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <textarea name="interest" class="form-control" rows="4"
                                                      placeholder="Write About Yourself....">{{old('interest')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin:10px 2px 2px 2px;">
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <input type="file" oninput="this.className = ''" name='image'
                                                   value="{{old('image')}}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div>
                                            ...
                                            <input type="file" oninput="this.className = ''" name='cv'
                                                   value="{{old('cv')}}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab">
                                <div class="row" style="margin:2px;">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="sel1" style="font-size: 22px;"> Educational
                                                Qualification</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="aitemWrapper">
                                                    <table class="table table-bordered amoreTable">
                                                        ...
                                                        <tr class="aitem_tr asingle_list">
                                                            ...
                                                            <td>
                                                                <select class="form-control degreeonchange"
                                                                        name="academic[0][degree]" id="degree">
                                                                    <option value="">SelectOption</option>
                                                                    @foreach ($data['deg'] as $item)
                                                                        <option value="{{$item->degree}}"
                                                                                data-id="{{$item->id}}">{{$item->degree}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
                                                            <td class="otherapp deloapp">
                                                                <select class="form-control institute delinst"
                                                                        name="academic[0][instname]">
                                                                    <option value="">Select</option>
                                                                    @foreach ($data['inst'] as $insti)
                                                                        <option
                                                                            value="{{$insti->name}}">{{$insti->name}}</option>
                                                                    @endforeach
                                                                    <option value="other">Other</option>
                                                                </select>
                                                                <input type="text" class="form-control otherinst"
                                                                       name="academic[0][instnameoth]"
                                                                       placeholder="Enter Institute Name"
                                                                       style="display:none">

                                                            </td>
                                                            <td><input type="text" class="form-control"
                                                                       name="academic[0][cgpa]"
                                                                       placeholder="EX:3.80 "><br></td>
                                                            <td>
                                                                <select class="form-control majorapp"
                                                                        name="academic[0][major]">
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select class="form-control minorapp"
                                                                        name="academic[0][minor]">
                                                                </select>
                                                            </td>
                                                            <td><input type="text" class="form-control"
                                                                       name="academic[0][location]"
                                                                       placeholder="Enter Location "><br></td>
                                                            <td><input type="date" class="form-control pyear"
                                                                       name="academic[0][pyear]" placeholder=" "><br>
                                                            </td>
                                    ...
                                    <div class="col-md-12">
                                        <div class="container"><p><span style="color:red">*</span> Please enter your
                                                last degree & it's score again</p></div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="title" class="col-4 control-label labelclass"><span
                                                            style="color:red">*</span> Last Degree</label>
                                                    <div class="col-10" style="max-width: 100%">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="title" class="col-8 control-label labelclass"><span
                                                            style="color:red">*</span> Score of Last Degree </label>
                                                    <div class="col-10" style="max-width: 100%">
                                                        <input type="text" class="form-control" id="l_score"
                                                               name="l_score" placeholder="EX:3.80" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab">
                                <div class="row" style="margin:2px;">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="sel1" style="font-size: 22px;"> Experience(Fill this, if you are
                                                not a fresher)</label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="list col-sm-12 " data-index_no="1000">
                                                <div class="itemWrapper">
                                                    <table class="table table-bordered moreTable">
                                                        <tr>
                                                            <th width="5%" class="labelclass">S.N</th>
                                                            <th width="20%" class="labelclass">Job Title &nbsp;&nbsp;&nbsp;</th>
                                                        ...
                                                        <tr class="item_tr single_list date_cls">
                                                            <td class="day_no labelclass">1</td>
                                                            <td><textarea cols="20" rows="1" type="text"
                                                                          class="form-control" id="pro_role"
                                                                          name="experience[0][title]"
                                                                          placeholder="Enter Job Title"></textarea></td>
                                                            <td><textarea cols="30" rows="1" type="text"
                                                                          class="form-control" id="pro_role"
                                                                          name="experience[0][company]"
                                                                          placeholder="Enter Company Name"></textarea>
                                                            </td>
                                                            <td><textarea cols="30" rows="1" type="text"
                                                                          class="form-control" id="pro_role"
                                                                          name="experience[0][responsibilites]"
                                                                          placeholder="Enter Responsibilites"></textarea>
                                                            </td>
                                                            {{-- <td><textarea cols="30" rows="1" type="date" class="form-control joinon" id="pro_role" name="experience[0][joinedin]" placeholder="Enter Joined date EX:dd-mm-yy"></textarea></td> --}}

                                                            {{-- <td style="display: flex" class="click_evt">
                                                                <textarea id="updateTextField" col="30" rows="1" class="form-control joinon updateTextField"  name="experience[0][joinedin]" placeholder="Enter Joined date EX:dd-mm-yy"></textarea>
                                                                <input type="input" id="fieldA"  class="datepicker fieldA" value="testdata" style="display: none;"/>
                                                            </td>
                                                            <td style="display: flex" class="click_evt">
                                                                <textarea id="updateTextField" col="30" rows="1" class="form-control lefton updateTextFieldtwo" name="experience[0][leftin]" placeholder="Enter Leftin date EX:dd-mm-yy"></textarea>
                                                                <input type="input" id="fieldB" class="datepicker fieldB" value="testdata"  style="display: none;"/>
                                                            </td> --}}




                                                            {{-- <td><textarea cols="30" rows="1" type="date" class="form-control lefton" id="pro_role" name="experience[0][leftin]" placeholder="Enter Leftin date EX:dd-mm-yy"></textarea></td> --}}
                                                            ...
                                                            <td><input type="date" value="2000-01-01"
                                                                       class="form-control joinon" id="myDate"
                                                                       name="experience[0][joinedin]"><br></td>
                                                            <td><input type="date" value="2001-01-01"
                                                                       class="form-control lefton" id="a_date"
                                                                       name="experience[0][leftin]"><br></td>
                                                ...
                                                <div class="witemWrapper">
                                                    <table class="table table-bordered wmoreTable">
                                                        ...
                                                        <tr class="witem_tr wsingle_list">
                                                            <td class="day_no labelclass">1</td>
                                                            <td><input type="text" class="form-control" id="pro_url"
                                                                       name="project[0][url]"
                                                                       placeholder="Enter Project Url"><br></td>
                                                            <td><textarea type="text" class="form-control"
                                                                          id="pro_comment" name="project[0][comment]"
                                                                          placeholder="Enter Description About Project"></textarea><br>
                                                            </td>
                                                ...
                                                <div class="acitemWrapper">
                                                    <table class="table table-bordered acmoreTable">
                                                        ...
                                                        <tr class="acitem_tr acsingle_list">
                                                            <td class="day_no labelclass">1</td>
                                                            <td><textarea type="text" class="form-control"
                                                                          id="achievement" rows="3"
                                                                          name="achievement[0][achieve]"
                                            ...
                                            <div class="sklist col-sm-12 " data-index_no="1000">
                                                <div class="skitemWrapper">
                                                    <table class="table table-bordered skmoreTable">
                                                        <tr>
                                                            <th width="5%" class="labelclass">S.N</th>
                                                            <th width="700%" class="labelclass">Professional Or
                                                                Technical Skills
                                                            </th>
                                                            <th width="10%" class="labelclass">Remove</th>
                                                        </tr>
                                                        ...
                                                        <tr class="skitem_tr sksingle_list">
                                                            <td class="day_no labelclass">1</td>
                                                            <td><input type="text" class="form-control" id="skill"
                                                                       name="skill[0][competent]"
                                                                       placeholder="Eg:HTML,CSS,JS"><br></td>
                                                ...
                                                <div class="reitemWrapper">
                                                    <table class="table table-bordered remoreTable">
                                                        ...
                                                        <tr class="reitem_tr resingle_list">
                                                            <td class="day_no labelclass">1</td>
                                                            <td><input type="text" class="form-control"
                                                                       name="reference[0][title]"
                                                                       placeholder="Enter Degree  Name"><br></td>
                                                            <td><input type="text" class="form-control"
                                                                       name="reference[0][company]"
                                                                       placeholder="Enter Institute Name"><br></td>
                                                            <td><input type="text" class="form-control"
                                                                       name="reference[0][contactinfo]"
                                                                       placeholder="Enter Score "><br></td>
                        ...
                        <div style="overflow:auto;" id="sub_btn">
                            <div class="text-center">
                                <button type="button" class="btn btn-info btn-lg btn_prev" id="prevBtn"
                                        onclick="nextPrev(-1)">Previous
                                </button>
                                <button type="button" class="btn btn-success btn-lg btn_next" id="nextBtn"
                                        onclick="nextPrev(1)"><b>Next</b></button>
                            </div>
                        </div>
...
//   y = x[currentTab].getElementsByTagName("input");
        ...
        {{-- <script>
                ...
                $('.date_cls').closest('.click_evt').children().datepicker({
                    showOn: "button",
                    buttonText: "::",
                    inline: true,
