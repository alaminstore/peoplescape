...
<body>
  @include('Frontend.include.header')
   ...
   <section class="page-banner-area" style="background: url({{asset('frontEnd/img/slider-img/sl11.jpg')}}); background-repeat: no-repeat; background-position: center; background-size: cover; background-attachment: fixed;">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
